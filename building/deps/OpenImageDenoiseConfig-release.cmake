...
set_target_properties(OpenImageDenoise PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${OIDN_ROOT}/lib/libOpenImageDenoise.so.2.3.0"
  IMPORTED_SONAME_RELEASE "libOpenImageDenoise.so"
  )

list(APPEND _cmake_import_check_targets OpenImageDenoise )
list(APPEND _cmake_import_check_files_for_OpenImageDenoise "${OIDN_ROOT}/lib/libOpenImageDenoise.so.2.3.0" )
