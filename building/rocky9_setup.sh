...
cmake ../source/building/Rocky9 -DInstallRoot="$HOME/.mfb/dependencies"
cmake --build . -- -j $(nproc)

rm -rf *
cmake ../source -DPYTHON_EXECUTABLE=python3 -DBOOST_PYTHON_COMPONENT_NAME=python39 -DABI_VERSION=0 -DCMAKE_PREFIX_PATH="$HOME/.mfb/dependencies"
cmake --build . -j $(nproc)
